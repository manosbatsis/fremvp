...
class RouteFilterPodVm(context: Context) : BaseViewModel(context), RouteFilterPodInputs, RouteFilterPodOutputs {
    val inPuts: RouteFilterPodInputs = this
    private val clickToItemChecked = PublishSubject.create<Port>()
    private val clickToTitlebar = PublishSubject.create<Parameter>()

    val outPuts: RouteFilterPodOutputs = this
