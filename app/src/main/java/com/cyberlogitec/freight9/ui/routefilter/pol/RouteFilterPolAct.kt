...
import kotlinx.android.synthetic.main.appbar_routefilter_pol.*
...
@RequiresActivityViewModel(value = RouteFilterPolVm::class)
class RouteFilterPolAct : BaseActivity<RouteFilterPolVm>(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_routefilter_pol)
        ...
        // set custom toolbar
        defaultbarInit(appbar_routefilter_pol, menuType = MenuType.POPUP, title = "", isEnableNavi=false)

        toolbar_pol.setSafeOnClickListener {
            Timber.d("f9: toolbar_pol click")
        ...
        viewModel.outPuts.onClickItemChecked()
                ...
                .subscribe {
                    ...
                    it?.let {
                        ...
                        val intent = Intent()
                        intent.putExtra("iPolCd", it.portCode)
                        intent.putExtra("iPolNm", it.portName)
    ...
    private fun recyclerViewInit() {
        recycler_view.apply {
            layoutManager = LinearLayoutManager(this@RouteFilterPolAct)
            adapter = this@RouteFilterPolAct.adapter
        }
    }

    private fun searchViewInit() {
        // SearchView init
        val id: Int = tx_search_pol.getContext().getResources().getIdentifier("android:id/search_src_text", null, null)
        val textView = tx_search_pol.findViewById(id) as TextView
        textView.setPadding(0, 2, 0, 2)
        textView.setTextColor(Color.BLACK)
        textView.setHintTextColor( ContextCompat.getColor(this, R.color.greyish_brown) )
        textView.setHint("From")

        tx_search_pol.setOnQueryTextListener( this )
    }
    ...
    private class RecyclerAdapter() : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
                ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_bof_content_pol, parent, false))
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            with(holder.itemView) {
                ...
                tv_content_polCd.text = data.portCode
                tv_content_polNm.text = data.portName
