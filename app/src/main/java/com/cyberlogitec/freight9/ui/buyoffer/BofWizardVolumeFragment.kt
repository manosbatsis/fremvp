...
class BofWizardVolumeFragment constructor(val viewModel: BofWizardViewModel): RxFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
            ...
            inflater.inflate(R.layout.fragment_bof_volume, container, false)
    ...
    override fun onResume() {
        ...
        viewModel.inPuts.requestVolumeOffer(Parameter.CLICK)
    }
    ...
    private fun recyclerViewInit() {
        recycler_volume.apply {
            layoutManager = LinearLayoutManager(this@BofWizardVolumeFragment.context)
            adapter = this@BofWizardVolumeFragment.adapter
        }
    }
    ...
    private fun setListener() {
        ...
        btn_next.setSafeOnClickListener {
            ...
            adapter.getData().let { offer ->
                ...
                viewModel.inPuts.requestGoToOtherStep(Pair(BofWizardActivity.STEP_PRICE, offer))
            }
        }
        ...
        private fun setInitItemView(itemView: View, position: Int) {
            ...
            lineItems.let { lineItems ->
                with(lineItems[position]) {
                    ...
                    itemView.et_volume_input_item.inputType = InputType.TYPE_NULL
    ...
    companion object {
        @JvmStatic
        fun newInstance(viewModel: BofWizardViewModel) : BofWizardVolumeFragment {
            return BofWizardVolumeFragment(viewModel)
        }
    }
}