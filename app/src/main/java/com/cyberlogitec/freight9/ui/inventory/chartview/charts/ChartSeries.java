 ...
 */
package com.cyberlogitec.freight9.ui.inventory.chartview.charts;
...
abstract public class ChartSeries {
    ...
    public void startAnimateMove(@NonNull final DecoEvent event) {
        ...
        mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                 ...
                 * possibly the user who is using a listener to update the appbar_progress_sof in an alternative
                 * manner, ie. displaying text appbar_progress_sof %
                 */
                for (SeriesItem.SeriesItemListener seriesItemListener : mSeriesItem.getListeners()) {
    ...
    /**
     * Calculates the current position of an series based on the appbar_progress_sof of the animation
     * being executed
     *
     ...
     * percentage, which is the appbar_progress_sof of the current operation, say moving from 100 to 110 may
    ...
    /**
     * Pause any move animation currently in appbar_progress_sof
     */
