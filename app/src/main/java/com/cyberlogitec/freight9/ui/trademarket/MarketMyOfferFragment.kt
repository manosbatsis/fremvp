...
class MarketMyOfferFragment constructor(val viewModel: BaseViewModel): RxFragment() {
   ...
   private val buyOfferAdapter by lazy {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?):
            View = inflater.inflate(R.layout.frag_market_myoffer, container, false)
    ...
    private fun recyclerViewInit() {
        ...
        rv_buyoffers.apply {
            ...
            adapter = this@MarketMyOfferFragment.buyOfferAdapter
        }
        rv_selloffers.apply {
            layoutManager = LinearLayoutManager(activity!!.applicationContext, RecyclerView.VERTICAL, false)
            adapter = this@MarketMyOfferFragment.sellOfferAdapter
        }
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(viewModel: BaseViewModel) : MarketMyOfferFragment {
            return MarketMyOfferFragment(viewModel)
        }
    }
